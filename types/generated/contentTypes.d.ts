...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u00C9quipe MVB'>;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    kitchenEquipped: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiRealisationRealisation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Vente', 'Location', 'Constructeur']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStatStat extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Statistiques et chiffres cl\u00E9s de l'entreprise";
  ...
  attributes: {
    ...
    icon: Schema.Attribute.Enumeration<
      ['home', 'users', 'trophy', 'euro', 'building', 'globe', 'star', 'heart']
    > &
      Schema.Attribute.Required &
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'T\u00E9moignages de clients satisfaits';
